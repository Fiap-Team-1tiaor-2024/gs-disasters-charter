...
def carregar_modelo(caminho_modelo:  str = 'modelo_risco_climatico.pkl',
                    caminho_encoder: str = 'label_encoder_risco.pkl') -> dict:
...
def carregar_modelo_preditivo(caminho: str = 'outputs_ml/modelo_preditivo_3h.pkl') -> dict | None:
...
def carregar_modelo_anomalia(caminho: str = 'outputs_ml/modelo_anomalias.pkl'):
...
def prever_risco_antecipado(
    ...
    hora_do_dia:   int = 12,
    mes:           int = 2,
    caminho_preditivo: str = 'outputs_ml/modelo_preditivo_3h.pkl',
) -> dict | None:
    """
...
def detectar_anomalia_pontual(
    ...
    caminho_anomalia: str = 'outputs_ml/modelo_anomalias.pkl',
) -> dict:
    """
